...
# Test case 1: Each employee should have at most one shift per day
...
# Test case 2: Part-time employees should not exceed 20 hours per week
...
# Test case 3: Full-time employees should not exceed 40 hours per week
...
# Test case 4: Full-time employees should work at least 40 hours per week
...
# Test case 5: Part-time employees should not work over 20 hours per week
...
# Test case 6: Expect no solution when insufficient full-time staff
...
# Test case 7: Not enough employees to cover all shifts (designed to fail)
...
# Test case 8: Each shift is assigned to exactly one employee
...
# Test case 9: Minimum staffing with full-time employees
...
# Test case 10: Insufficient staffing results in infeasible solution
...
# Test case 11: Initial model creation
...
# Test case 12: No available shifts
